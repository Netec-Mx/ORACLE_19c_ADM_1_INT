...
4. **Ejecutar el instalador de Oracle 12c**:
   ...
   # Antes de ejectutar el instalador, actualiza el ambiente a la base de datos Oracle 12c
    cd /home/oracle/scripts
    source setEnv2.sh

   # Cambiate al directorio del software de Oracle 12c y ejecuta el instalador.
...
3. **Ejecutar correcciones (Fixups):**
   ...
   ```bash
   sqlplus / as sysdba
   SQL> @/u01/app/oracle/cfgtoollogs/orcl2/preupgrade/preupgrade_fixups.sql
   ```
...
4. **Crear un punto de restauración garantizado (GRP):**
   ...
   ALTER DATABASE FLASHBACK ON;  * Nota: si da errores define el tamaño y ruta del FRA *
   ALTER DATABASE OPEN;
